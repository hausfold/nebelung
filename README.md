...
| category | # | ports |
| --- | ---: | --- |
| [terminals](docs/ports.md#terminals) | 10 | Ghostty · Kitty · Alacritty · Rio · Warp° · foot · Konsole° · Tabby° · Xresources · tty |
| [shell & prompt](docs/ports.md#shell--prompt) | 6 | Starship · fzf · zsh-syntax-highlighting · fish · skim · zsh-fsh |
| [multiplexers](docs/ports.md#multiplexers) | 2 | tmux · Zellij |
| [editors](docs/ports.md#editors) | 9 | Helix · Xcode° · micro · Zed · Emacs · Sublime Text · Kakoune · JetBrains° · VS Code / Cursor |
| [git](docs/ports.md#git) | 4 | delta · lazygit · gh-dash · gitui |
| [cli & tui](docs/ports.md#cli--tui) | 10 | btop · lsd · glow · bat · yazi · mpv · bottom · k9s · spotify-player · sc-im |
| [apps](docs/ports.md#apps) | 11 | Slack° · Obsidian · Zen · opencode · Raycast° · Dark Reader° · OBS° · zathura · Telegram° · qBittorrent° · Stylus° |
| [web](docs/ports.md#web) | 2 | chroma · CSS / Tailwind |
