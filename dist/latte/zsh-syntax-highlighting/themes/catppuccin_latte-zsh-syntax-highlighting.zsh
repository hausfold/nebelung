...
## Classes
## Comments
ZSH_HIGHLIGHT_STYLES[comment]='fg=#b0b0b0'
## Constants
## Entitites
## Functions/methods
...
ZSH_HIGHLIGHT_STYLES[command-substitution-delimiter]='fg=#515151'
ZSH_HIGHLIGHT_STYLES[command-substitution-delimiter-unquoted]='fg=#515151'
ZSH_HIGHLIGHT_STYLES[process-substitution-delimiter]='fg=#515151'
...
## Variables
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument]='fg=#515151'
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument-unclosed]='fg=#de5059'
ZSH_HIGHLIGHT_STYLES[dollar-double-quoted-argument]='fg=#515151'
ZSH_HIGHLIGHT_STYLES[assign]='fg=#515151'
ZSH_HIGHLIGHT_STYLES[named-fd]='fg=#515151'
ZSH_HIGHLIGHT_STYLES[numeric-fd]='fg=#515151'
## No category relevant in spec
ZSH_HIGHLIGHT_STYLES[unknown-token]='fg=#de5059'
ZSH_HIGHLIGHT_STYLES[path]='fg=#515151,underline'
ZSH_HIGHLIGHT_STYLES[path_pathseparator]='fg=#ca2a40,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix]='fg=#515151,underline'
ZSH_HIGHLIGHT_STYLES[path_prefix_pathseparator]='fg=#ca2a40,underline'
ZSH_HIGHLIGHT_STYLES[globbing]='fg=#515151'
...
ZSH_HIGHLIGHT_STYLES[redirection]='fg=#515151'
ZSH_HIGHLIGHT_STYLES[arg0]='fg=#515151'
ZSH_HIGHLIGHT_STYLES[default]='fg=#515151'
ZSH_HIGHLIGHT_STYLES[cursor]='fg=#515151'
